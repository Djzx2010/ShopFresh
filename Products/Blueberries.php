...
<html lang="en-CA">
    ...
    <body onload="refresh('Blueberries')">
        ...
        <div>
            ...
            <img class="ProductImage" src="images/BlueberriesImage.jpg" alt="Blueberries in a cardboard container.">
        </div>
        <!-- description of the product -->
        <div  class="description">

        <p>
        <h1>Blueberries &nbsp;&nbsp;&nbsp;&nbsp; <button id='btn' onclick="moreInfo('Blueberries')">More info</button></h1>
        <p><span id="info">Fresh blueberries from local market.</span></p>

        <h3>Local ShopFresh Brand</h3>
        170g<br><br>

        <h1 class="price" id="productPrice">$3.99</h1>
        &nbsp;&nbsp;&nbsp;&nbsp;

        <!-- Adding to cart -->
        <form class="add">
            <select id="quantity" onchange="calculate('Blueberries')">
            ...
            <button onclick="addToCart('Blueberries', 3.99)">Add to Cart</button>
        </form>
