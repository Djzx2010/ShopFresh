...
<html lang="en-CA">
    ...
    <body onload="refresh('Salmon')">
        ...
        <div>
            ...
            <img class="ProductImage" src="images/SalmonImage.jpg" alt="Raw salmon on parchement paper on a cutting board.">
        </div>

        <!-- description of the product -->
        <div class="description">
        <p>
        <h1>Salmon &nbsp;&nbsp;&nbsp;&nbsp; <button id="btn" onclick="moreInfo('Salmon')"></button></h1>
        <p><span id="info">Fresh Salmon from local sea market.</span></p>

        <h3>Local ShopFresh Brand</h3>
        200g (avg.)<br><br>
        
        <h1 class = "price" id="productPrice">$6.99</h1>
        &nbsp;&nbsp;&nbsp;&nbsp;

        <!-- Adding to cart -->
        <form class="add">
            <select id="quantity" onchange="calculate('Salmon')">
            ...
            <button onclick="addToCart('Salmon', 6.99)">Add to Cart</button>
        </form>
        </p>
        </div>
