...
<html lang="en-CA">
    ...
    <body onload="refresh('Butter')">
        ...
        <div>
            ...
            <img class="ProductImage" src="images/ButterImage.jpg" alt="Sliced butter on its wrapping.">
        </div>
        <!-- description of the product -->
        <div  class="description">
        <p>
            <h1>Butter &nbsp;&nbsp;&nbsp;&nbsp; <button id="btn" onclick="moreInfo('Butter')">More info</button></h1>
            <p><span id="info">Fresh locally churned Butter</span></p>
        <h3>Local ShopFresh Brand</h3>
        454g<br><br>
        <h1 class="price" id="productPrice">$4.69</h1>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <!-- Adding to cart -->
        <form class="add">
            <select id="quantity" onchange="calculate('Butter')">
            ...
            <button onclick="addToCart('Butter', 4.69)">Add to Cart</button>
        </form>
        </p>
        </div>
