...
<html lang="en-CA">
    ...
    <body onload="refresh('Strawberries')">
        ...
        <div>
            ...
            <img class="ProductImage" src="images/StrawberriesImage.jpg" alt="Strawberries in a plastic container.">
        </div>
        <!-- description of the product -->
        <div  class="description">
        <p>
        <h1>Strawberries &nbsp;&nbsp;&nbsp;&nbsp; <button id="btn" onclick="moreInfo('Strawberries')">More Info</button></h1>
        <p><span id="info">Fresh Strawberries from local market.</span></p>
        ...
        <!-- Adding to cart -->
        <form class="add">
            <select id="quantity" onchange="calculate('Strawberries')">
            ...
            <button onclick="addToCart('Strawberries', 4.99)">Add to Cart</button>
        </form>
        </p>
        </div>
