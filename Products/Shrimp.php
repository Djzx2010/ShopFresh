...
<html lang="en-CA">
    ...
    <body onload="refresh('Shrimp')">
        ...
        <div>
            ...
            <img class="ProductImage" src="images/ShrimpImage.jpg" alt="Cooked shrimp in butter, garlic and rosemary.">
        </div>
        <!-- description of the product -->
        <div class="description">
        <p>
        <h1>Shrimp &nbsp;&nbsp;&nbsp;&nbsp; <button id="btn" onclick="moreInfo('Shrimp')"></button></h1>
        <p><span id="info">Sustainably farmed frozen Pacific white shrimp.</span></p>

        <h3>ShopFresh Brand</h3>
        340g (avg.)<br><br>
        <h1 class = "price" id="productPrice">$11.99</h1>
        &nbsp;&nbsp;&nbsp;&nbsp;

        <!-- Adding to cart -->
        <form class="add">
            <select id="quantity" onchange="calculate('Shrimp')">
