...
<html lang="en-CA">
    ...
    <body onload="refresh('Bananas')">
        ...
        <div>
            ...
            <img class="ProductImage" src="images/BananasImage.jpg" alt="Bananas on grocery store shelf.">
        </div>
        <!-- description of the product -->
        <div  class="description">
        <p>
        <h1>Banana &nbsp;&nbsp;&nbsp;&nbsp; <button id="btn" onclick="moreInfo('Bananas')">More Info</button></h1>
        <p><span id="info">Fresh bananas from local market.</span></p>

        <h3>Tropical ShopFresh Brand</h3>
        190g (avg.)<br><br>
        <h1 class="price" id="productPrice">$1.79/kg</h1>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <!-- Adding to cart -->
        <form class="add">
            <select id="quantity" onchange="calculate('Bananas')">
            ...
            <button onclick="addToCart('Banana', 1.79)">Add to Cart</button>
        </form>
        </p>
        </div>
