...
<html lang="en-CA">
    ...
    <body onload="refresh('Zucchini')">
        ...
        <div>
            ...
            <img class="ProductImage" src="images/ZucchiniImage.jpg" alt="Zucchinis in a basket.">
        </div>
        <!-- description of the product -->
        <div  class="description">
        <p>
        <h1>Zucchini &nbsp;&nbsp;&nbsp;&nbsp; <button id="btn" onclick="moreInfo('Zucchini')">More Information</button></h1>
        <p><span id="info">Fresh zucchinis from local market.</span></p>
        ...
        <!-- Adding to cart -->
        <form class="add">
            <select id="quantity" onchange="calculate('Zucchini')">
            ...
            <button onclick="addToCart('Zucchini', 5.99)">Add to Cart</button>
        </form>
        </p>
        </div>
