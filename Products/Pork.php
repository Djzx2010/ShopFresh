...
<html lang="en-CA">
    ...
    <body onload="refresh('Pork')">
        ...
        <div>
            ...
            <img class="ProductImage" src="images/PorkImage.jpg" alt="Raw pork on a cutting board with knives.">
        </div>
        <!-- description of the product -->
        <div class="description">
        <p>
            <h1>Pork &nbsp;&nbsp;&nbsp;&nbsp; <button id="btn" onclick="moreInfo('Pork')">More info</button></h1>
            <p><span id="info">Cuts of Pork from local farms.</span></p>
        <h3>Local ShopFresh Brand</h3>
        1000g (avg.)<br><br>
        <h1 class="price" id="productPrice">$16.59/kg</h1>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <!-- Adding to cart -->
        <form class="add">
            <select id="quantity" onchange="calculate('Pork')">
            ...
            <button onclick="addToCart('Pork', 16.59)">Add to Cart</button>
        </form>
        </p>
        </div>
